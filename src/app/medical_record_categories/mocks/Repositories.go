...
func (_m *Repositories) InsertData(domain medical_record_categories.Domain) error {
...
func (_m *Repositories) SelectAllData() ([]medical_record_categories.Domain, error) {
	ret := _m.Called()
...
func (_m *Repositories) SelectDataByID(id int) (medical_record_categories.Domain, error) {
	ret := _m.Called(id)
...
func (_m *Repositories) UpdateByID(id int, domain medical_record_categories.Domain) error {
