...
func (_m *Repositories) InsertData(domain doctors.Domain) error {
	ret := _m.Called(domain)

	var r0 error
	if rf, ok := ret.Get(0).(func(doctors.Domain) error); ok {
		r0 = rf(domain)
	} else {
		r0 = ret.Error(0)
	}
...
func (_m *Repositories) SelectAllData() ([]doctors.Domain, error) {
	ret := _m.Called()
...
func (_m *Repositories) SelectDataByEmail(email string) (doctors.Domain, error) {
	ret := _m.Called(email)
...
func (_m *Repositories) SelectDataByID(id string) (doctors.Domain, error) {
	ret := _m.Called(id)
...
func (_m *Repositories) UpdateByID(id string, domain doctors.Domain) error {
